...
class ControleurCreer_article {
    ...
    public function route_creer_article() {
        ...
        if(isset($_POST['submit']))
        {
            ...
            if(isset($_POST['categorie2']) && !empty($_POST['categorie2']) && !isset($_POST['categorie']))
            {   
            ...
            if(isset($_POST['categorie']) && !empty($_POST['categorie']) && empty($_POST['categorie2']) && !isset($_POST['categorie2']))
            {
